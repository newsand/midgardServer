package Valhalla.MidgardWebserver.model;
...
public class TemperatureRegister {
	...
	public TemperatureRegister(Document p_doc) {
		this.m_hardwareId = p_doc.getInteger("hardwareId");
		this.m_sensorId = p_doc.getInteger("sensorId");
		this.m_registerTime = p_doc.getString("registerTime");
		//String temp = p_doc.getString("Temperature");
		this.m_temperature = p_doc.getDouble("temperature");
		this.m_hardwareId = p_doc.getInteger("hardwareId");
	}
